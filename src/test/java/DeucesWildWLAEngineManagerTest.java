...
public class DeucesWildWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(DeucesWildWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/DeucesWildWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/DeucesWildWLAIW/InitOutcome.xml").getDocumentElement();
