				...
				<lxslt:script lang="javascript">
					...
					//	r.push('<br>');
						...
						if (bonusCount >= 3)
						{
							...
							r.push('<tr class="tablehead">');
							r.push('<td>');
							r.push(getTranslationByName("bonusGame", translations) + " " + bonusCount + " " + getTranslationByName("jokerHats", translations));
							r.push('</td>');
							r.push('</tr>');
							...
							for (var i in bonusScenario)
							{
								...
								{
									r.push(getTranslationByName("jokerHatRemoved", translations));
								}
